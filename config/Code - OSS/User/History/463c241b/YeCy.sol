...
contract PlatformRegistryTest is Test {
    ...
    function test_SetFeePercentage() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(PlatformRegistry.InvalidFeePercentage.selector));
        vm.prank(owner);
    ...
    function test_SetFeeAddress() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(PlatformRegistry.AddressZero.selector));
        vm.prank(owner);
    ...
    function test_OnlyVerifiedCanCreateCampaign() public {
        vm.expectRevert(abi.encodeWithSelector(PlatformRegistry.OrganizationIsNotVerified.selector));
        vm.prank(org2);
    ...
    function test_RewardDonor() public {
        ...
        CharityCampaign campaign = CharityCampaign(campaignAddr);
        ...
        uint expectedReward = (donationAmount * 90 / 100) * registry.TOKEN_REWARD_RATE() / 1 ether;
...
contract CharityCampaignTest is Test {
    ...
    function setUp() public {
        ...
        vm.prank(org1);
        address campaignAddr = registry.createCampaign(goal, duration);
        campaign = CharityCampaign(campaignAddr);
    ...
    function test_DonateAfterDeadline() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(CharityCampaign.CampaignHasEnded.selector));
    ...
    function test_DonateAfterGoalReached() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(CharityCampaign.GoalAlreadyReached.selector));
    ...
    function test_CreateSpendingRequest() public {
        ...
        (bytes32 descHash, uint reqAmount, address reqRecipient, bool executed, uint votes) = campaign.spendingRequests(0);
    ...
    function test_VoteForRequest() public {
        ...
        assertEq(campaign.spendingRequests(0).approvalVotes, 6 ether);
        
        vm.expectRevert(abi.encodeWithSelector(CharityCampaign.AlreadyVoted.selector));
        vm.prank(donor1);
        campaign.voteForRequest(0);
    }
    ...
    function test_ExecuteRequest() public {
        ...
        assertTrue(campaign.spendingRequests(0).executed);
