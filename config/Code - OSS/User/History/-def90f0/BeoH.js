...
async function main() {
	...
	// Подключаемся к контракту PlatformRegistry
	const registry = await hre.ethers.getContractAt(
		'PlatformRegistry',
		'0x959922bE3CAee4b8Cd9a407cc3ac1C251C2007B1' // Замени на реальный адрес
	)

	// Проверяем, верифицирована ли организация
	...
	// Создаём кампанию от имени организации
	const goalInETH = '0.5' // Цель в ETH
	...
	// Парсим событие CampaignCreated
