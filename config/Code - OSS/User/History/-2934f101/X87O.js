...
async function setupLocalEnvironment() {
	...
	contractAddress = '0x9f1ac54BEF0DD2f6f3462EA0fa94fC62300d3a8e' // Или ваш адрес
...
async function confirmDonation() {
	...
	try {
		// TODO нужно научиться парсить ввод пользователя
		const amountText = '0.01'
		...
		const tx = await contract.donate({ value: 100000 })
        ...
        // TODO сделать небольшую задержку этого сообщения
		if (progressText) {
