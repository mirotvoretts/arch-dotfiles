...
contract PlatformRegistry is Ownable {
    ...
    constructor(address initialOwner, uint8 feePercentage)
    ...
    function verify(address _organizationAddress, bool _isVerified)
        external
        onlyOwner
    {
    ...
    function createCampaign(uint256 _goal, uint256 _deadline)
        external
    ...
    function isNewFeePercentageCorrect(uint256 _newValue)
        private
        pure
        returns (bool)
    {
