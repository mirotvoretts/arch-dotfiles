...
contract CharityCampaign is ReentrancyGuard {
    ...
    event RequestCreated(uint256 indexed requestId, string description); // Остальное можно получить view-вызовом
event RequestVoted(uint256 indexed requestId, address indexed voter); // voteWeight не нужен в ивенте
