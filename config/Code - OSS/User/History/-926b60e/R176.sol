...
contract CharityCampaign is ReentrancyGuard {
    ...
    event RequestCreated(uint96 indexed requestId, string description, uint256 amount, address indexed recipient);
    event RequestVoted(uint96 indexed requestId, address indexed voter, uint256 voteWeight);
